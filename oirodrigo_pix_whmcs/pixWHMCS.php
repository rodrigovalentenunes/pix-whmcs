...
class Pix {
    ...
    public static function generateQrCodePIX($code) {
    ...
    public static function mai($key) {
        ...
        $total_len = $gui_len + $key_len + 4 + 4 + \strlen($gui_len_pad) + \strlen($key_len_pad) + 8;
    ...
    public static function descricao($descricao, $key) {
        // $tam_max_descr=99-(4+4+14+strlen($key));
        // if (strlen($descricao) > $tam_max_descr) {
        //     $descricao=substr($descricao,0,$tam_max_descr);
        // }
        // $value_len_pad = self::lpad(\strlen($descricao));
        return '0208' . $descricao;
    }
